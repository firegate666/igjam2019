...
namespace LeoLuz
{
    ...
    public class AnalogicKnob : MonoBehaviour
    {
		...
		public bool HorizontalInvertAxis;
        [InputAxesListDropdown]
        public string VerticalAxis = "Vertical";
		public bool VerticalInvertAxis;
...
#endif
            Input.SetAxisMobile(HorizontalAxis, NormalizedAxis.x * (HorizontalInvertAxis ? -1 : 1));
            Input.SetAxisMobile(VerticalAxis, NormalizedAxis.y * (VerticalInvertAxis ? -1 : 1));
